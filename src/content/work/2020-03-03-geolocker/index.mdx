...
details:
  - tools: "React, 3box, Solidity, Mapbox, Turf"
    status: "Prototype"
featuredImage: "./hero-geolocker.png"
customHero: "HeroGeolocker"
ogimage: "./ogimage.png"
twitterimage: "./twitterimage.png"
---

## Introducing 🌐 [Geolocker](https://github.com/johnx25bd/topo-sol)

A spatial data registry on Ethereum and 3Box
